  ...
  <div class="min-h-screen bg-gray-50">
    <header class="bg-white border-b border-gray-200">
      <div class="px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
        <router-link to="/teacher/courses" class="font-bold text-gray-900 shrink-0">{{ t('layout.teacherBrand') }}</router-link>
        ...
        <div class="hidden md:flex items-center gap-4 text-sm text-gray-600 flex-wrap">
          ...
          <router-link to="/teacher/dashboard" class="hover:text-gray-900">{{ t('dashboard.navLink') }}</router-link>
          <router-link to="/teacher/calendar" class="hover:text-gray-900">📅</router-link>
          <router-link to="/teacher/plans" class="hover:text-gray-900">📋</router-link>
          <router-link to="/teacher/staff-meetings" class="hover:text-gray-900">{{ t('staffMeeting.navLink') }}</router-link>
          <MessagingBell />
          <NotificationBell />
          <LanguageSwitcher />
      ...
      <div v-if="mobileMenuOpen" class="md:hidden border-t border-gray-200 px-4 py-3 space-y-3">
        <nav class="flex flex-col gap-3 text-sm" @click="mobileMenuOpen = false">
          ...
          <router-link to="/teacher/dashboard" class="text-gray-600 hover:text-gray-900">{{ t('dashboard.navLink') }}</router-link>
          <router-link to="/teacher/calendar" class="text-gray-600 hover:text-gray-900">📅 {{ t('layout.navCalendar') }}</router-link>
          <router-link to="/teacher/plans" class="text-gray-600 hover:text-gray-900">📋 {{ t('layout.navPlans') }}</router-link>
          <router-link to="/teacher/staff-meetings" class="text-gray-600 hover:text-gray-900">{{ t('staffMeeting.navLink') }}</router-link>
        </nav>

...
class Frais_divers(QDialog):
    ...
    def __init__(self,frais_edit):
        ...
        self.dialog = QDialog()
        self.dialog.setWindowTitle("Frais divers")
    ...
    def enregistrer_frais_divers(self, niveaux):
        self.dialog.setStyleSheet(
                ...
                QLabel,QComboBox{font-size:13pt}
                """
            )
        ...
        # layout.addWidget(label_frais)
        # layout.addWidget(self.input_frais)
    ...
    def enregistrer(self):
        ...
        response = self.save_data.enregistrer_frais_divers(id=self.id_input_frais.text(),prix=montant, description=description,niveau_id=niveau, anneeAc=annee)
        if response:

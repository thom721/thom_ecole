...
<template>
  <div class="mx-auto px-4 pb-20">
    ...
    <div
      ...
      class="mt-6 bg-[#161b27] border border-white/[0.07] rounded-2xl overflow-hidden animate-[slideUp_0.3s_ease_both]"
    >

      <!-- En-tête -->
      <div class="bg-[#1a2033] border-b border-white/[0.07] px-6 py-5">
            ...
            <div v-else class="relative">
              ...
              >
                ...
                <template v-if="data_students.examEcheance?.evaluation_par?.toLowerCase() === 'mois'">
                  <!-- <option v-for="(val, key) in month" :key="key" :value="key">{{ key }}</option> -->

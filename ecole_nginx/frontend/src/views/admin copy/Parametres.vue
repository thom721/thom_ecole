...
<template> 
    <div class="bg-gray-100 pb-10">
      <div class="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 pt-4">
        ...
        <!-- MODAL: Grade/Niveau -->
        <!-- ===================================== -->
        <DialogModal :show="grade_etude" @close="gradeModalClose">
          <template #title>
        ...
        <!-- ===================================== -->
        <DialogModal :show="faculte_profession" @close="facModalClose">
          <template #title>
        ...
        <!-- ===================================== -->
        <DialogModal :show="anneeAcademique" @close="yearModalClose">
          <template #title>
        ...
        <!-- MODAL: Classe -->
        <!-- ===================================== -->
        <DialogModal :show="niveau_detude_modal_classe" @close="niveauModalClose">
          <template #title>
        ...
        <!-- ===================================== -->
        <DialogModal :show="frais" @close="fraisModalClose">
          <template #title>
        ...
        <!-- ===================================== -->
        <DialogModal :show="exam_params" @close="examParamsModalClose">
          <template #title>
        ...
        <!-- ===================================== -->
        <DialogModal :show="Payment_params_show" @close="paymentParamsModalClose">
          <template #title>

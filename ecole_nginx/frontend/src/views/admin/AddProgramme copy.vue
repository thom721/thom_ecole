...
<template>
  ...
  <div v-else class="max-w-7xl px-4 mx-auto pb-14 text-slate-700">
    <div class="mb-8">
      <h1 class="text-2xl text-slate-400">Programmation des cours</h1>
      <p class="text-slate-500 text-sm">Affectez des professeurs et des horaires aux matières par classe.</p>
    </div>

    <form @submit.prevent="submitProgramme" class="space-y-6 bg-[#0d1117]">
      <div v-for="(programme, index) in programmeCours" :key="index" 
           class=" p-5 rounded-xl border border-sky-500 shadow-sm transition-all bg-[#161b22]"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select v-model="programme.niveau_id" @change="handleNiveauChange($event, index)" class="field-input">
          ...
          <div>
            ...
            <select v-model="programme.cours_id" class="field-select">
          ...
          <div>
            ...
            <select v-model="programme.professeur_id" class="field-input">
          ...
          <div>
            ...
            <TextInput v-model="programme.coefficients" type="number" class="w-full field-input" />
          </div>

          <div v-if="choseNiveau.name === 'Universitaire' || choseNiveau.name === 'Professionel'">
            <InputLabel value="Faculté / Option" />
            <select v-model="programme.faculte_id" class="field-input">
          ...
          <div>
            ...
            <!-- <select v-model="programme.class" class="field-input">
          ...
          <div>
            ...
            <select v-model="programme.annee_academique" class="field-input">
          ...
          <div>
            ...
            <select v-model="programme.jours" class="field-input">
          ...
          <div>
            ...
            <TextInput v-model="programme.heure" type="text" class="w-full mt-1 field-input" />
          </div>
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-4 bg-[#161b22] p-4 rounded-xl">

  ...
  navSections: {
    ...
    default: () => [
      ...
      },
      {
        label: 'Gestion',
        items: [
          { name: 'calendrier',   label: 'Calendrier',   to: 'professeur-calendrier',   badge: null,
          ...
          { name: 'statistiques', label: 'Statistiques', to: 'professeur-statistiques', badge: null,
          ...
          { name: 'Profile',   label: 'Profile',   to: 'profile',   badge: null,
...
<template>
  <div class="min-h-screen bg-[#0f1117] text-[#e8eaf0] font-sans flex w-full" :style="cssVars">

    ...
    def get_connection(self):
        ...
        try:
            ...
            conn = pymysql.connect(
               # host = f"{self.ip_manager.get_server_ip()}",
               port = 3307,
               user = "user_pyside",
               password = "@#Janvier21",
               database = "lemignon",    
               ...
               # mysql -u user_pyside -p --ssl-mode=REQUIRED   
               ssl_ca='C:/ProgramData/certs/ca-cert.pem',
               ssl_cert='C:/ProgramData/certs/client-cert.pem',
               ssl_key='C:/ProgramData/certs/client-key.pem', 

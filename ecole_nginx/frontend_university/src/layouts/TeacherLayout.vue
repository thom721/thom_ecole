...
<template>
  ...
  >
    ...
    <!-- ░░ MAIN WRAPPER ░░
         FIX: En mobile, margin-left = 0 toujours.
         Le sidebar est `fixed` donc il flotte au-dessus.
         En desktop, on décale le main selon l'état du sidebar.
    -->
    <div
          ...
          <div id="profile-menu" class="relative">
            ...
            >
              ...
              >
                ...
                <div class="py-1">
                  <!-- Symétrique du lien "Espace Professeur" côté AdminLayout.vue :
                  un compte admin qui porte aussi le rôle enseignant peut revenir
                  au dashboard admin sans se reconnecter. -->
                  <RouterLink
                    v-if="authStore.roleNames.includes('admin')"
                    :to="{ name: 'Dashboard' }"
                  ...
                  >
                    <svg class="w-4 h-4 text-[#7c83a0]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
    ...
    default: () => [
      {
        ...
        items: [
          ...
          { name: 'teacher.classes',    label: "Mes Sessions / Années d'étude", to: 'professeur-classes', badge: '6',

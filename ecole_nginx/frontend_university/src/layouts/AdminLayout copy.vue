    ...
    default: () => [
      {
        ...
        items: [
          ...
          {
            name: 'Administration', label: 'Administration', to: '/administration', badge: null,
...
<template>
  <!--
    FIX MOBILE OVERFLOW:
    - `overflow-x-hidden` sur la racine empêche le scroll horizontal
    - Le sidebar est `fixed` et ne pousse PAS le contenu en mobile
    - Le main n'a PAS de margin en mobile, seulement en desktop
  -->
  <div

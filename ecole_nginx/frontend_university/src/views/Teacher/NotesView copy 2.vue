    ...
    <div class="flex flex-wrap items-start justify-between gap-3">
      ...
      <div class="flex gap-2"> 
        <button type="button" class="btn-outline-orange" @click="modalBulletin = true">Bulletin</button> 
          <router-link :style="{ background: 'var(--accent,#4f8ef7)' }" 
          to="/professeur-ajouter-notes" class="px-4 py-2 text-white rounded-md text-sm font-medium hover:brightness-110 transition-all cursor-pointer border-0">

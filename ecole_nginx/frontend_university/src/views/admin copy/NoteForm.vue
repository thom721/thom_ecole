    ...
    <!-- <div v-if="data_students?.result" class="mt-6 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden"> -->
      ...
      <div class="p-6 bg-slate-50 border-b border-slate-100">
        <div class="grid md:grid-cols-3 gap-6 items-end">
          ...
          <div>
            <p class="text-sm text-slate-400 uppercase  tracking-wider">Cours : <span class="text-sky-600 ml-8">{{ saveFormNote.cours }}</span> </p> 
            <p class="font-medium">
                ...
                <td class="p-2 bg-slate-50/50">
                  <div class="flex flex-col items-center">
                    <input 
                      ...
                      step="0.1"
                      min="0" 
                      class="w-20 text-center  py-1 rounded border border-slate-300 focus:border-sky-500 focus:ring-sky-500 shadow-sm"

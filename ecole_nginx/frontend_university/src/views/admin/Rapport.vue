    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div class="bg-[#161b26] rounded-2xl border border-white/[0.07] overflow-hidden">
          ...
          <div class="px-5 py-4 space-y-3">
            <div>
              <label class="block text-[11px] font-medium text-[#7c83a0] uppercase tracking-wider mb-1.5">Session / Année d'étude</label>
              <select v-model="forms.payment.classe" class="dark-select">
                <option value="All">Toutes les sessions/classes</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3 items-end">
              ...
              <div>
                ...
                <select v-model="forms.pedago.classe" class="dark-select">
                  ...
                  <option value="Toutes les classes">Toutes les sessions/classes</option>
            ...
            <div>
              ...
              <div class="space-y-2.5">
                <div class="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    <label class="block text-[10px] text-[#7c83a0] mb-1">Session / Année d'étude</label>
                    <select v-model="forms.admin.classe" class="dark-select text-[12px]">
                      <option value="All">Toutes sessions/classes</option>

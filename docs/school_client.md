...
- Le lien ouvert (`QDesktopServices.openUrl`) et la synchro de licence (`LicenceSyncWorker`) pointent vers `INFINI_API_BASE_URL = "https://infini-sofware.cloud"` (domaine de production, `Controllers/Main.py`).
